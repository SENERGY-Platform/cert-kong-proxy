...
from cert_kong_proxy.app import app
...
class AppTestCase(unittest.TestCase):
    ...
    @mock.patch('cert_kong_proxy.app.make_ocsp_request', side_effect=mock_bad_ocsp)
    ...
    @mock.patch('cert_kong_proxy.app.make_ocsp_request', side_effect=mock_good_ocsp)
